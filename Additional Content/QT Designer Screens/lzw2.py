...
# Form implementation generated from reading ui file 'learningzonewindow2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.homeButton.setGeometry(QtCore.QRect(770, 960, 121, 71))
        self.homeButton.setStyleSheet("background-color: rgb(3, 193, 161);\n"
"border-radius: 15px;")
        self.homeButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Desktop/home-solid.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.homeButton.setIcon(icon)
        self.homeButton.setIconSize(QtCore.QSize(50, 60))
        self.homeButton.setObjectName("homeButton")
        self.freePlayButton = QtWidgets.QPushButton(self.centralwidget)
        self.freePlayButton.setGeometry(QtCore.QRect(900, 960, 211, 70))
        font = QtGui.QFont()
...
"border-radius: 15px;")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Developer/Swansea Uni/Project/Code/Project/Images/play-circle-regular.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.quizButton.setGeometry(QtCore.QRect(1120, 960, 121, 71))
        self.quizButton.setStyleSheet("background-color: rgb(3, 193, 161);\n"
"border-radius: 15px;")
        self.quizButton.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Desktop/Screenshot 2020-06-26 at 11.46.35.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
