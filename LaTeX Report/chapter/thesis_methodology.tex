\chapter{Design}
	...
	%\begin{figure}[t]
	%	\includegraphics[width=15cm]{graphics/ui_ga.png}
	%	\caption{Each screen available within the application.}
	%	\label{fig:ui_ga}
	%\end{figure}
	...
	%\begin{figure}[t]
	%	\includegraphics[width=15cm]{graphics/ui_lz.png}
	%	\caption{Each screen available within the application.}
	%	\label{fig:ui_lz}
	%\end{figure}
	...
	%\begin{figure}[t]
	%	\includegraphics[width=15cm]{graphics/ui_fp.png}
	%	\caption{Each screen available within the application.}
	%	\label{fig:ui_fp}
	%\end{figure}
	...
	%\begin{figure}[t]
	%	\includegraphics[width=15cm]{graphics/ui_az.png}
	%	\caption{Each screen available within the application.}
	%	\label{fig:ui_az}
	%\end{figure}
